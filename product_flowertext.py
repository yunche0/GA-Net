...
dataset_path = '/root/autodl-tmp/PIXIU/data/Oxford_flowers/jpg'
output_train_file = "test/word/flower_file_list_train.txt"
output_test_file = "test/word/flower_file_list_test.txt"
